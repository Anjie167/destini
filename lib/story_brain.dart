...
void restart(){
  ...
  int nextStory(int choiceNumber){
    ...
    if (_storyNumber == 2){
      if(choiceNumber==1) {return _storyNumber = 5;}
      if(choiceNumber==2){return _storyNumber = 4;}
  ...
  bool buttonShouldBeVisible(){
    if(storyBrain._storyNumber == 0 || storyBrain._storyNumber == 1 || storyBrain._storyNumber== 2)
    {
      return true;
    }else{return false;}
  }
